...
class Test_translation_files(unittest.TestCase):
    def test_translation_file_keys(self):
        ...
        for path in JSON_PATHS:
            ...
            english_dictionary = json_file_to_python_dictionary(
                os.path.join(module_path, "EN.json")
            )
...
mock_email_en = {"subject": "Lox Invoice - {company}: {month} {year}"}

mock_email_en_with_variables = {"subject": "Lox Invoice - Helloprint: September 2022"}
...
class Test_insert_variables(unittest.TestCase):
    def test_translations_with_variables(self):
        self.assertDictEqual(
            insert_variables(
                mock_email_en, company="Helloprint", month="September", year="2022"
            ),
        ...
        self.assertDictEqual(
            insert_variables(
                ...
                total_with_vat="7300€",
                invoice_due_date="15/07/2022",
                IBAN="NL12 3456 7890 12",
