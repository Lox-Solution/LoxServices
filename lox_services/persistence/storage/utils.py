...
def generate_invoice_storage_url(company: str, carrier: str, tracking_number: str) -> str:
    """generate the storage url for client invoices
        ...
        ## Returns
            str
    """
    return os.path.join(INVOICE_BASE_URL, company, "Invoices", carrier, f"{tracking_number}.pdf")
