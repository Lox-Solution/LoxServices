...
def safe_find_element(driver: webdriver.Chrome, *, selector_type: By = By.CSS_SELECTOR, selector: str, timeout: int = 10) -> WebElement:
...
def safe_find_elements(driver: webdriver.Chrome, *, selector_type: By = By.CSS_SELECTOR, selector: str, timeout: int = 10)  -> List[WebElement]:
...
def wait_until_clickable_and_click(wait: WebDriverWait, selector: str, timeout: int = 30):
...
def wait_then_clear(driver: webdriver.Chrome, wait: WebDriverWait, selector: str) -> None:
...
def wait_then_send_keys(driver: webdriver.Chrome, wait: WebDriverWait,  selector: str, input_text: str, clear: bool = False):
...
def safe_send_keys(driver: webdriver.Chrome, selector: str, input_text: str, selector_type: By = By.CSS_SELECTOR):
...
def wait_till_disapear(wait: WebDriverWait, selector_type: By, selector: str, timeout: int = 60):
...
class JamesBond():
    def __init__(self):
        ...
        self.typing_speed = round(random.uniform(self.clicking_speed/2, self.clicking_speed), 2)
